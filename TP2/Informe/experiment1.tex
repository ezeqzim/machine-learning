...
\ig{Imagenes/Results/exp1/zero_any_move/zero_any_move.png}{Porcentaje de victorias de Q-Learner contra Random en ventanas de 500 partidas}

\ig{Imagenes/Results/exp1/zero_any_move/zero_any_move_acum.png}{Porcentaje de victorias totales de Q-Learner contra Random}
...
\ig{Imagenes/Results/exp1/validation/valid_test_validation.png}{Porcentaje de victorias de Q-Learner contra Random en ventanas de 500 partidas con epsilon = 0}

\ig{Imagenes/Results/exp1/validation/valid_test_validation_acum.png}{Porcentaje total de victorias de Q-Learner contra Random con epsilon = 0}
