...
\miniig{Imagenes/Results/exp1/zero_any_move/zero_any_move.png}{Porcentaje de victorias de Q-Learner en ventanas de 500 partidas}{Imagenes/Results/exp1/zero_any_move/zero_any_move_acum.png}{Porcentaje de victorias totales de Q-Learner a lo largo de las iteraciones}
...
\miniig{Imagenes/Results/exp1/normal_validation/normal_validation_validation.png}{Porcentaje de victorias de Q-Learner en ventanas de 500 partidas con $\varepsilon = 0$}{Imagenes/Results/exp1/normal_validation/normal_validation_validation_acum.png}{Porcentaje total de victorias de Q-Learner a lo largo de las iteraciones con $\varepsilon = 0$}
