...
\ig{Imagenes/Results/exp1/validation/valid_test_validation.png}{Porcentaje de victorias de Q-Learner en ventanas de 500 partidas con $\varepsilon = 0$}

\ig{Imagenes/Results/exp1/validation/valid_test_validation_acum.png}{Porcentaje total de victorias de Q-Learner a lo largo de las iteraciones con $\varepsilon = 0$}
